...
@property (nonatomic, strong) CCSegmentBarConfig *config;

@end

@implementation CCSegmentBar



#pragma mark - 接口
+ (instancetype)segmentBarWithFrame: (CGRect)frame {
    CCSegmentBar *segmentBar = [[CCSegmentBar alloc] initWithFrame:frame];
...
- (CCSegmentBarConfig *)config {
    if (!_config) {
        _config = [CCSegmentBarConfig defaultConfig];
    }
    return _config;
}
